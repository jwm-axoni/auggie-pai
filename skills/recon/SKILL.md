...
When performing recon in the context of Axonius work:
- Use claude-browser MCP to check internal documentation at docs.axonius.com
- Cross-reference discovered assets with Axonius asset inventory concepts
- Consider the SaaS attack surface model relevant to cybersecurity platforms
- Check Jira/Atlas via claude-browser for related security tickets if relevant
